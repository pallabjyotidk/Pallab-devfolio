...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1Ny-cAjPra-G7swJi6MstXPRg7X5lub0_/view?usp=drive_link", // Set to empty to hide the button
...
const socialMediaLinks = {
  github: "https://github.com/pallabjyotidk",
  linkedin: "https://www.linkedin.com/in/pallabjyotideka/",
  gmail: "pallabjyotidk@gmail.com",
  medium: "https://medium.com/@pallabjyotidk",
  ...
  schools: [
    {
      ...
      logo: require("./assets/images/iitkgp_logo.png"),
      subHeader: "Master of Technology in Computer Science and Data Processing",
      duration: "July 2019 - May 2021",
      desc: "CGPA - 8.49/10 | M.Tech thesis - Single Image Deraining using CGAN",
      descBullets: [
    ...
    {
      schoolName: "Assam Engineering College",
      logo: require("./assets/images/aec_logo.png"),
      subHeader: "Bachelor of Engineering in Electrical Engineering",
      duration: "September 2014 - April 2018",
      desc: "Grade - 77.85% with Honors",
      descBullets: ["Digital Image Processing", "Signals & Systems", "Microprocessor Based Instrumentation", "Control Systems"]
    }
  ]
};
...
const techStack = {
  ...
  experience: [
    {
      Stack: "Computer Vision/Deep Learning", //Insert stack or technology you have experience in
...
const workExperiences = {
  ...
  experience: [
    ...
    },
    {
      ...
      companylogo: require("./assets/images/hcl_logo.webp"),
      date: "July 2021 – May 2023",
      desc: "Developed and deployed multiple Golang microservices on production as a part of the product IntelliService using tech-stacks such as Golang, ElasticSearch, PostgreSQL, Docker, Kubernetes."
    }
  ]
};
...
const contactInfo = {
  ...
  email_address: "pallabjyotidk@gmail.com"
};

// Twitter Section

const twitterDetails = {
  userName: "iam_pjd", //Replace "twitter" with your twitter username without @
  display: true // Set true to display this section, defaults to false
};
